            ...
            <div class="border rounded-lg p-2 space-y-3">
                <form id="form" onsubmit="return storeData()">
                  ...
                  <div class="flex justify-between gap-2 mt-3 hidden" id="btnConfirm">
                      <button type="submit" class="block rounded-md bg-blue-500 hover:bg-blue-700 text-white font-bold text-center py-3 w-full"
                      >
                          Simpan
                      </button>
                      <a onclick="clearForm()" class="block rounded-md bg-red-500 hover:bg-red-700 text-white font-bold text-center py-3 w-full"
                      >
                          Clear
                      </a>
                  </div>
                    <div class="flex justify-between gap-2 mt-3 hidden" id="btnCetak">
                        <a type="submit" id="cetakBtn" class="block rounded-md bg-green-500 hover:bg-green-700 text-white font-bold text-center py-3 w-full"
                        >
                            Cetak
                        </a>
                        <a onclick="clearForm()" class="block rounded-md bg-red-500 hover:bg-red-700 text-white font-bold text-center py-3 w-full"
