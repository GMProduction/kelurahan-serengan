    ...
    <div class="flex h-full">
        <div id="sidebar" class="bg-white shadow-sm h-full fixed top-0 left-0 sidebar">
            ...
            <div class="p-3 py-5">
                ...
                <a class="menu {{ request()->is('/') ? 'bg-primarylight' : '' }}  nav-link" href="/admin/pengguna">
                ...
                <a class="menu {{ request()->is('/') ? 'bg-primarylight' : '' }}  nav-link" href="/admin/laporan">

                    <span class="material-symbols-outlined mr-3">
                        monitoring
                    </span>
                    <p class="title-menu block menu-text">Laporan Pengajuan Surat</p>
                </a>
