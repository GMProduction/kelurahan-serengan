                        ...
                        <div class="grid grid-cols-3 gap-4 ">
                            ...
                            <div>
                                <label for="temlahir"
                                    ...
                                    Lahir</label>
                                <input type="text" name="tempat_lahir" id="temlahir"
                            ...
                            <div>
                                ...
                                <textarea type="text" name="tempat_tinggal" id="tempat_tinggal"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Tempat Tinggal" required="">{{ old('tempat_tinggal') }}</textarea>
                            ...
                            <div>
                                ...
                                <div class="flex gap-1">
                                    <input type="password" name="password" id="password" placeholder="••••••••"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        required="">
                                    <span class="flex items-center"><a role="button" id="btnShow"
                                            onclick="showPass(this,'password')" class="hide">
                            ...
                            <div>
                                ...
                                <div class="flex gap-1">
                                    <input type="password" name="password_confirmation" id="password_confirmation"
                                        ...
                                        required="">
                                    <span class="flex items-center"><a role="button" id="btnShow"
                                            onclick="showPass(this,'password_confirmation')" class="hide">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                class="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round"
